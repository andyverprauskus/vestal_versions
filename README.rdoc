...
* Version version_tagging. Any version can have a version_tag attached to it (must be unique within the scope of the versioned parent) and that version_tag can be used for reversion.

    @user.name # => "Steve Richert"
    @user.update_attribute(:last_name, "Jobs")
    @user.name # => "Steve Jobs"
    @user.version_tag_version("apple")
    @user.update_attribute(:last_name, "Richert")
    @user.name # => "Steve Richert"
    @user.revert_to("apple")
    @user.name # => "Steve Jobs"

  So if you're not big on version numbers, you could just version_tag your versions and avoid the numbers altogether.
