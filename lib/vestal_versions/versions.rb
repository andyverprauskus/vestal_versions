module VestalVersions
  ...
  module Versions
    ...
    # * A String: A string value represents a version version_tag and the associated version is searched
    #   for by a matching version_tag value. *Note:* Be careful with string representations of numbers.
